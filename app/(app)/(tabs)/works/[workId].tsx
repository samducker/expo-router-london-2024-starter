    ...
    <SafeAreaView className="flex-1">
      <View className="flex-row align-middle justify-between bg-white px-4 py-4 border-b border-b-shade-2">
        ...
        <View className="justify-center px-4">
          ...
          >
            <Icon name={isFav ? "star" : "star-border"} color={colors.tint} size={28} />
          </Pressable>
        </View>
      </View>
      <ScrollView
      ...
      >
        <View className="flex-1">
          ...
          <View className="flex-1">
            ...
            {work?.description && (
              <>
                <Text className="text-xl font-semibold px-4 py-2">Description</Text>
            ...
            {work?.did_you_know && (
              <>
                <Text className="text-xl font-semibold px-4 py-2">Did you know?</Text>
                <View className="px-4 gap-y-2 py-2">
                  <Text className="text-lg leading-6 font-light">
